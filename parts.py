...
def renderPage2():
    if "cassette" not in session:
        ...
        session["rim"]=rquest.form["rim"]
        session["spokes"]=rquest.form["spokes"]
        session["spokeNipples"]=rquest.form["spokeNipples"]
        session["hub"]=rquest.form["hub"]
        session["tube"]=rquest.form["tube"]
        session[""]=rquest.form[""]
        session[""]=rquest.form[""]
        session[""]=rquest.form[""]
        session[""]=rquest.form[""]
