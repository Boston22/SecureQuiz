...
def renderAnswers():
    ...
    if session["rotor"]==" metal disc affixed to each wheel hub that runs in between the brake pads in the brake calipers on the bike frame":
        ...
        incorrect=incorrect+Markup("47. Rotor"+"<br><b>your answer:</b> "+session["rotor"]+"<br> <b>correct answer:</b>"+"  metal disc affixed to each wheel hub that runs in between the brake pads in the brake calipers on the bike frame<br><br>")
